<div class="space-y-6">
    <div class="bg-white p-6 rounded-lg shadow-md">
        <h2 class="text-xl font-semibold mb-4">{{ $editingOptionId ? 'Modifier' : 'Ajouter' }} un Add-on</h2>
        <form wire:submit.prevent="save" class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="md:col-span-2 flex justify-end gap-2">
                @if($editingOptionId)
                    <button type="button" wire:click="$set('editingOptionId', null); $reset(['name', 'description', 'type', 'value', 'calculation_base'])" class="bg-gray-500 text-white px-4 py-2 rounded-md hover:bg-gray-600 flex items-center">
