            ...
            <form wire:submit.prevent="save" class="space-y-6">
                ...
                <div class="grid md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" wire:model="price_lifetime" class="w-full p-2 border-2 border-gray-300 dark:border-gray-600 rounded-lg focus:border-blue-500 focus:ring focus:ring-blue-200 outline-none transition bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100" placeholder="Optionnel">
                    </div>
                </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl border-2 {{ $plan->is_active ? 'border-slate-200 dark:border-gray-700' : 'border-red-100 bg-red-50/30 dark:border-red-900 dark:bg-red-900/10' }} overflow-hidden hover:shadow-lg transition duration-300">
                <div class="p-6">
                    ...
                    <div class="space-y-2 mb-6">
                        <p class="text-2xl font-black text-slate-900 dark:text-gray-100">{{ number_format($plan->price_monthly, 0) }}€ <span class="text-sm font-normal text-slate-500 dark:text-gray-400">/mois</span></p>
                        <p class="text-sm text-slate-500 dark:text-gray-400">{{ number_format($plan->price_yearly, 0) }}€ /an</p>
                    </div>
